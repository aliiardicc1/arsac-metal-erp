...
if __name__ == '__main__':
    ...
    # DB yolu kontrolü — ilk kurulumda veya ayar yoksa sor
    from database import db_yolu_al, db_yolu_kaydet, ayarlari_oku
    import os as _os

    ayarlar = ayarlari_oku()
    db_yolu = ayarlar.get("db_yolu", "")
    db_hazir = db_yolu and _os.path.exists(_os.path.dirname(db_yolu) if _os.path.dirname(db_yolu) else ".")
    ...
    from database import baglanti_kur
